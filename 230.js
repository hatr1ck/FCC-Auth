...
app.post('/login', (req, res) => {
   ...
   /*
     ...
     To do that you can use `Array.find()` method that will iterate through `DataBase` and return user by matching username from login form and username stored in database.
